...
int Lesson07::entry(void) {

    // create window
    GLFWwindow* window = createGraphicWindow("OpenGL Lesson 07", 800, 600, false);
    ...
    const char* paths[] = {"lesson_07_vertex.glsl", "lesson_07_frament.glsl"};
