...
int Lesson11::entry(void) {

    // create window
    GLFWwindow* window = createGraphicWindow("OpenGL Lesson 11", 800, 600, true);
    ...
    const char* shader_paths[] = {"lesson_11_vertex.glsl", "lesson_11_frament.glsl"};
